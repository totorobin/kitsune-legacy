 ...
 * - src/features/solutionFinder.feature (définition des scénarios)
 * - src/features/step_definitions/solutionFinder.steps.ts (implémentation des étapes)
 * 
...
import { findSolutions, getTopSolutions, generateConciseExpression, Solution } from './solutionFinder';
